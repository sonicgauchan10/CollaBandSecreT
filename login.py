...
title=Label(a, text="BSLR MART",font=("Microsoft Yahei UI Light",20,"bold"), bg="white").place(x=50,y=0)
img=Image.open(r"logo.png") #image logo
img=img.resize((30,30))
new_logo=ImageTk.PhotoImage(img)
image=Label(image=new_logo,border=0,bg="black").place(x=5,y=3)
label1=LabelFrame(project,height=35,fg="white",bg="#57a1f8").place(x=0,y=0)
...
image=Label(image=img,bg="blue").place(x=900,y=(screen_height/4)+25)

#creating frame for login
frame2=Frame(project,width=450,height=445,bg="white", highlightthickness=2,highlightbackground="blue")
frame2.place(x=screen_width-1200,y=screen_height/4)
heading=Label(frame2,text='Log In',fg="black",bg="white",font=("Arial",40))
...
label=Label(frame2,text="Create account?",fg="black",bg="white",font=("Microsoft Yahei UI Light",14))
